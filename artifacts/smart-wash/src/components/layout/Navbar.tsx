  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Button asChild className="rounded-full px-8 bg-primary hover:bg-primary/90 text-white border-none">
      ...
      >
        ...
        <Button asChild size="lg" className="rounded-full px-8 text-lg mt-4">
          <a href="https://bosmartwash.in/see.html" target="_blank" rel="noopener noreferrer">
            Schedule Pickup Now
          </a>
        </Button>
